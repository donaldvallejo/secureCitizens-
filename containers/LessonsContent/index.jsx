...
const Container = styled(motion.div)(() => [
	tw`flex flex-col items-center px-4 py-32 text-white bg-gray-800 `,
]);

const Heading = styled(motion.h1)(() => [
	tw`text-2xl font-bold text-center uppercase text-alternative-400`,
	tw` sm:text-4xl`,
]);

const SubHeading = styled(motion.h3)(() => [
	tw`mb-4 text-base font-bold text-center text-alternative-400`,
	tw` sm:text-xl`,
]);
...
const BorderBox = styled(motion.div)(() => [
	...
	// tw`border-8 border-gray-700 border-double`,
...
const InstrumentWrapper = styled(motion.div)(() => [
	tw`grid justify-around w-full grid-cols-2 gap-4 p-2 `,
]);
